    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 py-3">
          <h2 class="title-section">Narrador</h2>
            ...
            <h2 class="title-section"> Tyler Durden </h2>
            ...
            <h2 class="title-section"> Marla Singer </h2>
            <p>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3">
            <h2 class="title-section">Pruebe que edad sale con su nombre</h2>
          </div>
        </div>
      </div>  
      ...
      <form action="/api" method="post">
        ...
        <div class="api">
          ...
          <div class="col-lg-12">
            <fieldset>
              <button type="submit" id="submit" class="main-button">Calcular Probabilidad</button><br>
            </fieldset>
          </div>
        </div>
      </form>
